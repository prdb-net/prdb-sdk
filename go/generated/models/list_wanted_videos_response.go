...
func NewListWantedVideosResponse()(*ListWantedVideosResponse) {
    m := &ListWantedVideosResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateListWantedVideosResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateListWantedVideosResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewListWantedVideosResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ListWantedVideosResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ListWantedVideosResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    res := make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateWantedVideoSummaryDtoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]WantedVideoSummaryDtoable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(WantedVideoSummaryDtoable)
                }
            }
            m.SetItems(res)
        }
...
func (m *ListWantedVideosResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetItems() != nil {
...
type ListWantedVideosResponseable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetItems()([]WantedVideoSummaryDtoable)
    GetPage()(*int32)
    GetPageSize()(*int32)
    GetSortBy()(*string)
    ...
    GetTotalCount()(*int32)
    GetTotalPages()(*int32)
    SetItems(value []WantedVideoSummaryDtoable)()
    SetPage(value *int32)()
