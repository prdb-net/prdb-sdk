...
func NewListFavoriteActorsResponse()(*ListFavoriteActorsResponse) {
    m := &ListFavoriteActorsResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateListFavoriteActorsResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateListFavoriteActorsResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewListFavoriteActorsResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ListFavoriteActorsResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ListFavoriteActorsResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    res := make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateFavoriteActorSummaryDtoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]FavoriteActorSummaryDtoable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(FavoriteActorSummaryDtoable)
                }
            }
            m.SetItems(res)
        }
...
func (m *ListFavoriteActorsResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetItems() != nil {
...
type ListFavoriteActorsResponseable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetItems()([]FavoriteActorSummaryDtoable)
    GetPage()(*int32)
    GetPageSize()(*int32)
    GetSortBy()(*string)
    ...
    GetTotalCount()(*int32)
    GetTotalPages()(*int32)
    SetItems(value []FavoriteActorSummaryDtoable)()
    SetPage(value *int32)()
