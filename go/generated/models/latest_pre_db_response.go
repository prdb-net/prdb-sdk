...
func NewLatestPreDbResponse()(*LatestPreDbResponse) {
    m := &LatestPreDbResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateLatestPreDbResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateLatestPreDbResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewLatestPreDbResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *LatestPreDbResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *LatestPreDbResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    res := make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateLatestPreDbItemDtoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]LatestPreDbItemDtoable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(LatestPreDbItemDtoable)
                }
            }
            m.SetItems(res)
        }
...
// returns a []LatestPreDbItemDtoable when successful
...
func (m *LatestPreDbResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetItems() != nil {
...
func (m *LatestPreDbResponse) SetAdditionalData(value map[string]any)() {
...
type LatestPreDbResponseable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetItems()([]LatestPreDbItemDtoable)
    GetPage()(*int32)
    GetPageSize()(*int32)
    GetTotalCount()(*int32)
    SetItems(value []LatestPreDbItemDtoable)()
    SetPage(value *int32)()
