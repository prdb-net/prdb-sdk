...
// BatchRequestBuilder builds and executes requests for operations under \videos\batch
...
func NewBatchRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BatchRequestBuilder) {
    m := &BatchRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/videos/batch", pathParameters),
    }
    return m
}
...
func (m *BatchRequestBuilder) Post(ctx context.Context, body ibd6e645a776717494d1d5787141076f1557418587bd7a4afc54fef213b93abb9.GetVideosByIdsRequestable, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])([]ibd6e645a776717494d1d5787141076f1557418587bd7a4afc54fef213b93abb9.VideoDetailDtoable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, ibd6e645a776717494d1d5787141076f1557418587bd7a4afc54fef213b93abb9.CreateVideoDetailDtoFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]ibd6e645a776717494d1d5787141076f1557418587bd7a4afc54fef213b93abb9.VideoDetailDtoable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(ibd6e645a776717494d1d5787141076f1557418587bd7a4afc54fef213b93abb9.VideoDetailDtoable)
        }
    }
    return val, nil
}
