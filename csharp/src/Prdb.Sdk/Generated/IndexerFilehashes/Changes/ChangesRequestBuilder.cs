...
namespace Prdb.Sdk.Generated.IndexerFilehashes.Changes
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Prdb.Sdk.Generated.IndexerFilehashes.Changes.ChangesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChangesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/indexer-filehashes/changes{?IndexerId*,IndexerSource*,PageSize*,Since*,SinceId*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Prdb.Sdk.Generated.IndexerFilehashes.Changes.ChangesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChangesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/indexer-filehashes/changes{?IndexerId*,IndexerSource*,PageSize*,Since*,SinceId*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<global::Prdb.Sdk.Generated.Models.GetIndexerFilehashChangesResponse> GetAsync(Action<RequestConfiguration<global::Prdb.Sdk.Generated.IndexerFilehashes.Changes.ChangesRequestBuilder.ChangesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Prdb.Sdk.Generated.Models.GetIndexerFilehashChangesResponse>(requestInfo, global::Prdb.Sdk.Generated.Models.GetIndexerFilehashChangesResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns a seek-paged delta feed of indexer filehash rows ordered by updatedAtUtc ascending, then id ascending. Includes created, updated, and soft-deleted rows as full payloads. Use since and the returned nextCursor to continue incrementally. Supports optional indexer source and indexer ID filters. Every page carries serverTimeUtc, the server clock read when the page was produced; persist it as the next since when items is empty. Requires API key authentication.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Prdb.Sdk.Generated.IndexerFilehashes.Changes.ChangesRequestBuilder.ChangesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Prdb.Sdk.Generated.IndexerFilehashes.Changes.ChangesRequestBuilder.ChangesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Prdb.Sdk.Generated.IndexerFilehashes.Changes.ChangesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Prdb.Sdk.Generated.IndexerFilehashes.Changes.ChangesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Prdb.Sdk.Generated.IndexerFilehashes.Changes.ChangesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns a seek-paged delta feed of indexer filehash rows ordered by updatedAtUtc ascending, then id ascending. Includes created, updated, and soft-deleted rows as full payloads. Use since and the returned nextCursor to continue incrementally. Supports optional indexer source and indexer ID filters. Every page carries serverTimeUtc, the server clock read when the page was produced; persist it as the next since when items is empty. Requires API key authentication.
        /// </summary>
