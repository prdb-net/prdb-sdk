...
using System;
namespace Prdb.Sdk.Generated.FavoriteActors.Changes
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Prdb.Sdk.Generated.FavoriteActors.Changes.ChangesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChangesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/favorite-actors/changes{?PageSize*,Since*,SinceId*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Prdb.Sdk.Generated.FavoriteActors.Changes.ChangesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChangesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/favorite-actors/changes{?PageSize*,Since*,SinceId*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Prdb.Sdk.Generated.FavoriteActors.Changes.ChangesRequestBuilder.ChangesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Prdb.Sdk.Generated.FavoriteActors.Changes.ChangesRequestBuilder.ChangesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Prdb.Sdk.Generated.FavoriteActors.Changes.ChangesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Prdb.Sdk.Generated.FavoriteActors.Changes.ChangesRequestBuilder WithUrl(string rawUrl)
        {
