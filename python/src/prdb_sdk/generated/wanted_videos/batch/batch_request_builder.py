...
if TYPE_CHECKING:
    from ...models.add_wanted_videos_batch_request import AddWantedVideosBatchRequest
    from ...models.add_wanted_videos_batch_response import AddWantedVideosBatchResponse
...
class BatchRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/wanted-videos/batch", path_parameters)
    ...
    async def post(self,body: AddWantedVideosBatchRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AddWantedVideosBatchResponse]:
        ...
        return await self.request_adapter.send_async(request_info, AddWantedVideosBatchResponse, error_mapping)
