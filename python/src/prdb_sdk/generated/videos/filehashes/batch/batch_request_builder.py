...
if TYPE_CHECKING:
    from ....models.get_video_filehashes_by_video_ids_request import GetVideoFilehashesByVideoIdsRequest
    from ....models.get_video_filehashes_by_video_ids_response import GetVideoFilehashesByVideoIdsResponse
...
class BatchRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/videos/filehashes/batch", path_parameters)
    ...
    async def post(self,body: GetVideoFilehashesByVideoIdsRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GetVideoFilehashesByVideoIdsResponse]:
        ...
        return await self.request_adapter.send_async(request_info, GetVideoFilehashesByVideoIdsResponse, error_mapping)
