...
if TYPE_CHECKING:
    from ...models.get_videos_by_ids_request import GetVideosByIdsRequest
...
class BatchRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/videos/batch", path_parameters)
    ...
    async def post(self,body: GetVideosByIdsRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[list[VideoDetailDto]]:
        ...
        return await self.request_adapter.send_collection_async(request_info, VideoDetailDto, error_mapping)
