...
if TYPE_CHECKING:
    from ....models.get_video_image_changes_response import GetVideoImageChangesResponse
...
class ChangesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/videos/images/changes{?PageSize*,Since*,SinceId*,SiteId*,VideoId*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ChangesRequestBuilderGetQueryParameters]] = None) -> Optional[GetVideoImageChangesResponse]:
        """
        ...
        Returns: Optional[GetVideoImageChangesResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetVideoImageChangesResponse, error_mapping)
