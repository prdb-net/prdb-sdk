...
if TYPE_CHECKING:
    from ...models.get_favorite_actor_changes_response import GetFavoriteActorChangesResponse
    from ...models.problem_details import ProblemDetails

class ChangesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /favorite-actors/changes
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/favorite-actors/changes{?PageSize*,Since*,SinceId*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ChangesRequestBuilderGetQueryParameters]] = None) -> Optional[GetFavoriteActorChangesResponse]:
        """
        ...
        Returns: Optional[GetFavoriteActorChangesResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetFavoriteActorChangesResponse, error_mapping)
