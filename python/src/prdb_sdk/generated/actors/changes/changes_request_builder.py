...
if TYPE_CHECKING:
    from ...models.get_actor_changes_response import GetActorChangesResponse
...
class ChangesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ChangesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActorChangesResponse]:
        ...
        return await self.request_adapter.send_async(request_info, GetActorChangesResponse, error_mapping)
