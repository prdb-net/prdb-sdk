...
if TYPE_CHECKING:
    from ...models.get_favorite_site_changes_response import GetFavoriteSiteChangesResponse
...
class ChangesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/favorite-sites/changes{?PageSize*,Since*,SinceId*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ChangesRequestBuilderGetQueryParameters]] = None) -> Optional[GetFavoriteSiteChangesResponse]:
        """
        ...
        Returns: Optional[GetFavoriteSiteChangesResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetFavoriteSiteChangesResponse, error_mapping)
