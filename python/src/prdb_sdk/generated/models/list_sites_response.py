...
if TYPE_CHECKING:
    from .site_summary_dto import SiteSummaryDto

@dataclass
class ListSitesResponse(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # The items property
    items: Optional[list[SiteSummaryDto]] = None
    # The page property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ListSitesResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(SiteSummaryDto)),
