...
@dataclass
class FavoriteActorChangesCursorDto(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FavoriteActorChangesCursorDto:
        """
        ...
        return FavoriteActorChangesCursorDto()
