...
@dataclass
class VideoFilehashChangeFilehashDto(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> VideoFilehashChangeFilehashDto:
        """
        ...
        return VideoFilehashChangeFilehashDto()
