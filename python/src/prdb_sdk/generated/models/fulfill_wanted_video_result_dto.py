...
@dataclass
class FulfillWantedVideoResultDto(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FulfillWantedVideoResultDto:
        """
        ...
        return FulfillWantedVideoResultDto()
