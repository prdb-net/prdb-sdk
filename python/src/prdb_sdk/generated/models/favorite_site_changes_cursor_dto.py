...
@dataclass
class FavoriteSiteChangesCursorDto(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FavoriteSiteChangesCursorDto:
        """
        ...
        return FavoriteSiteChangesCursorDto()
