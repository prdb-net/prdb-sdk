...
@dataclass
class VideoFilehashChangesCursorDto(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> VideoFilehashChangesCursorDto:
        """
        ...
        return VideoFilehashChangesCursorDto()
