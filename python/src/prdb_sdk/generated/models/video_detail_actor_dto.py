...
if TYPE_CHECKING:
    from .video_detail_actor_image_dto import VideoDetailActorImageDto

@dataclass
class VideoDetailActorDto(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> VideoDetailActorDto:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "images": lambda n : setattr(self, 'images', n.get_collection_of_object_values(VideoDetailActorImageDto)),
