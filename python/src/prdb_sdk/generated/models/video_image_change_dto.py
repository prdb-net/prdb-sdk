...
if TYPE_CHECKING:
    from .video_image_change_image_dto import VideoImageChangeImageDto

@dataclass
class VideoImageChangeDto(AdditionalDataHolder, Parsable):
    """
    ...
    image: Optional[VideoImageChangeImageDto] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> VideoImageChangeDto:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "image": lambda n : setattr(self, 'image', n.get_object_value(VideoImageChangeImageDto)),
        }
        return fields
