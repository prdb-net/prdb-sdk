...
if TYPE_CHECKING:
    from .identify_video_result_dto import IdentifyVideoResultDto
...
class IdentifyVideosResponse(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> IdentifyVideosResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "results": lambda n : setattr(self, 'results', n.get_collection_of_object_values(IdentifyVideoResultDto)),
        }
        return fields
