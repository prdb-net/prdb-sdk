...
@dataclass
class UpdateDownloadedFromIndexerFilenameRequest(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UpdateDownloadedFromIndexerFilenameRequest:
        """
        ...
        return UpdateDownloadedFromIndexerFilenameRequest()
