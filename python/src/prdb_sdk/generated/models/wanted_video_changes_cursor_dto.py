...
@dataclass
class WantedVideoChangesCursorDto(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WantedVideoChangesCursorDto:
        """
        ...
        return WantedVideoChangesCursorDto()
