...
if TYPE_CHECKING:
    from .actor_alias_dto import ActorAliasDto
    from .actor_bio_dto import ActorBioDto
    from .actor_image_detail_dto import ActorImageDetailDto
    from .actor_link_dto import ActorLinkDto

@dataclass
class ActorDetailDto(AdditionalDataHolder, Parsable):
    """
    ...
    aliases: Optional[list[ActorAliasDto]] = None
    # The bios property
    bios: Optional[list[ActorBioDto]] = None
    ...
    # The images property
    images: Optional[list[ActorImageDetailDto]] = None
    # The links property
    links: Optional[list[ActorLinkDto]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ActorDetailDto:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "aliases": lambda n : setattr(self, 'aliases', n.get_collection_of_object_values(ActorAliasDto)),
            "bios": lambda n : setattr(self, 'bios', n.get_collection_of_object_values(ActorBioDto)),
            ...
            "images": lambda n : setattr(self, 'images', n.get_collection_of_object_values(ActorImageDetailDto)),
            "links": lambda n : setattr(self, 'links', n.get_collection_of_object_values(ActorLinkDto)),
