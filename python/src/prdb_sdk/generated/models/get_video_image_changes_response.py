...
if TYPE_CHECKING:
    from .video_image_changes_cursor_dto import VideoImageChangesCursorDto
    from .video_image_change_dto import VideoImageChangeDto

@dataclass
class GetVideoImageChangesResponse(AdditionalDataHolder, Parsable):
    """
    ...
    # The items property
    items: Optional[list[VideoImageChangeDto]] = None
    # Seek cursor for continuing a video image change feed.
    next_cursor: Optional[VideoImageChangesCursorDto] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetVideoImageChangesResponse:
        """
        ...
        return GetVideoImageChangesResponse()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(VideoImageChangeDto)),
            "nextCursor": lambda n : setattr(self, 'next_cursor', n.get_object_value(VideoImageChangesCursorDto)),
