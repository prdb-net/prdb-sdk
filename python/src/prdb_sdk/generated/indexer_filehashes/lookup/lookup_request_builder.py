...
if TYPE_CHECKING:
    from ...models.lookup_indexer_filehashes_request import LookupIndexerFilehashesRequest
    from ...models.lookup_indexer_filehashes_response import LookupIndexerFilehashesResponse
...
class LookupRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/indexer-filehashes/lookup", path_parameters)
    ...
    async def post(self,body: LookupIndexerFilehashesRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LookupIndexerFilehashesResponse]:
        ...
        return await self.request_adapter.send_async(request_info, LookupIndexerFilehashesResponse, error_mapping)
