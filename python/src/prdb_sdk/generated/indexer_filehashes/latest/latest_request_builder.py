...
if TYPE_CHECKING:
    from ...models.latest_indexer_filehashes_response import LatestIndexerFilehashesResponse
...
class LatestRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/indexer-filehashes/latest{?CreatedFrom*,CreatedTo*,IndexerId*,IndexerSource*,IsVerified*,Page*,PageSize*,SortBy*,SortDirection*,UpdatedFrom*,UpdatedTo*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[LatestRequestBuilderGetQueryParameters]] = None) -> Optional[LatestIndexerFilehashesResponse]:
        """
        ...
        Returns: Optional[LatestIndexerFilehashesResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, LatestIndexerFilehashesResponse, error_mapping)
