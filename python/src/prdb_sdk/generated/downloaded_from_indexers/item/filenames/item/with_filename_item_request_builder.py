...
if TYPE_CHECKING:
    ...
    from .....models.update_downloaded_from_indexer_filename_request import UpdateDownloadedFromIndexerFilenameRequest
...
class WithFilenameItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/downloaded-from-indexers/{downloadedFromIndexerId}/filenames/{filenameId}", path_parameters)
    ...
    async def put(self,body: UpdateDownloadedFromIndexerFilenameRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DownloadedFromIndexerResponse]:
        """
    ...
    def to_put_request_information(self,body: UpdateDownloadedFromIndexerFilenameRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Updates a single filename row for a downloaded-from-indexer entry owned by the currently authenticated user. Returns 409 when the filename would duplicate another filename under the same parent.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
