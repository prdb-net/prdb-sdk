...
if TYPE_CHECKING:
    from ...models.get_video_user_image_changes_response import GetVideoUserImageChangesResponse
...
class ChangesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/video-user-images/changes{?PageSize*,Since*,SinceId*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ChangesRequestBuilderGetQueryParameters]] = None) -> Optional[GetVideoUserImageChangesResponse]:
        ...
        return await self.request_adapter.send_async(request_info, GetVideoUserImageChangesResponse, error_mapping)
