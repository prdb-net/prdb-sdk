...
// @ts-ignore
import { createGetWantedVideoChangesResponseFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, type GetWantedVideoChangesResponse, type ProblemDetails } from '../../models/index.js';
// @ts-ignore
...
export interface ChangesRequestBuilder extends BaseRequestBuilder<ChangesRequestBuilder> {
     ...
     * @returns {Promise<GetWantedVideoChangesResponse>}
     * @throws {ProblemDetails} error when the service returns a 400 status code
     * @throws {ProblemDetails} error when the service returns a 401 status code
     */
     get(requestConfiguration?: RequestConfiguration<ChangesRequestBuilderGetQueryParameters> | undefined) : Promise<GetWantedVideoChangesResponse | undefined>;
    /**
     * Returns a seek-paged delta feed of wanted video rows for the currently authenticated user ordered by updatedAtUtc ascending, then videoId ascending. Includes created, updated, and soft-deleted rows as full payloads. Use since and the returned nextCursor to continue incrementally. Requires API key authentication.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ChangesRequestBuilderUriTemplate = "{+baseurl}/wanted-videos/changes{?PageSize*,Since*,SinceId*}";
/**
...
export const ChangesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createGetWantedVideoChangesResponseFromDiscriminatorValue,
